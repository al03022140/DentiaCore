...
TextBox.prototype.setNote = function(note, preserveFecha) {
    ...
    // Asignar fecha cuando se modifica la nota, a menos que se indique preservar la fecha existente
    if (note && note.trim() !== "" && !preserveFecha) {
        this.fecha = getCurrentDateFormatted();
    }
};
